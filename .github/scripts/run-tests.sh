...
uv run coverage run -a -m opshin build examples/smart_contracts/dual_use.py -fforce-three-params
uv run coverage run -a -m opshin build examples/smart_contracts/dual_use.py -fforce-three-params -O0
uv run coverage run -a -m opshin build examples/smart_contracts/dual_use.py -fforce-three-params -O1
uv run coverage run -a -m opshin build examples/smart_contracts/dual_use.py -fforce-three-params -O2
uv run coverage run -a -m opshin build examples/smart_contracts/dual_use.py -fforce-three-params -O3
