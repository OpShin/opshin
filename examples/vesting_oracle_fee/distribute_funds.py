...
builder.add_output(
    TransactionOutput.from_primitive([oracle_collateral_address.encode(), 5000000])
)
builder.add_output(
    TransactionOutput.from_primitive([vesting_collateral_address.encode(), 5000000])
)
builder.add_output(
    TransactionOutput.from_primitive([oracle_address.encode(), 100000000])
)
builder.add_output(
    TransactionOutput.from_primitive([beneficiary_address.encode(), 100000000])
)
