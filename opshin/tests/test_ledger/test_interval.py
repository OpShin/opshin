...
def test_ext_posinf_before(
    ...
    assert (
        entirely_before_ext(make_range(lower_bound, upper_bound), PosInfPOSIXTime())
        == True
    )
...
def test_ext_posinf_before(
    ...
    assert (
        entirely_before_ext(make_range(lower_bound, upper_bound), NegInfPOSIXTime())
        == False
    )
...
def test_ext_posinf_after(
    ...
    assert (
        entirely_after_ext(make_range(lower_bound, upper_bound), PosInfPOSIXTime())
        == False
    )
...
def test_ext_posinf_after(
    ...
    assert (
        entirely_after_ext(make_range(lower_bound, upper_bound), NegInfPOSIXTime())
        == True
    )
